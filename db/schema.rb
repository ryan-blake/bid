...
ActiveRecord::Schema.define(version: 20160626193344) do
  ...
  add_index "charges", ["laborer_id"], name: "index_charges_on_laborer_id"
  ...
  add_index "jobs", ["selected_submission_id"], name: "index_jobs_on_selected_submission_id"
  ...
  add_index "mailboxer_conversations", ["job_id"], name: "index_mailboxer_conversations_on_job_id"
  ...
  add_index "reviews", ["laborer_id"], name: "index_reviews_on_laborer_id"

  create_table "selected_submissions", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
